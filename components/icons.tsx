...
export const DocumentIcon = ({ size = 16 }: { size: number }) => {
  return (
    <svg
      ...
      fill="currentColor"
    >
      <path d="M4 0H12C13.1 0 14 0.9 14 2V14C14 15.1 13.1 16 12 16H4C2.9 16 2 15.1 2 14V2C2 0.9 2.9 0 4 0ZM4 1C3.45 1 3 1.45 3 2V14C3 14.55 3.45 15 4 15H12C12.55 15 13 14.55 13 14V2C13 1.45 12.55 1 12 1H4ZM5 3H11V4H5V3ZM5 5H11V6H5V5ZM5 7H11V8H5V7ZM5 9H11V10H5V9ZM5 11H11V12H5V11Z" />
    </svg>
  );
};
